...
2. Open /src/data/fabrics.json and find the entry with id: honeycomb-shade
3. Add an object to its colors array:

  { code: IW-01, name: Ivory White, image: /images/fabrics/honeycomb-shade/ivory-white.jpg }
