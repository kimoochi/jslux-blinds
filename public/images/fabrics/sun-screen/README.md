...
2. Open /src/data/fabrics.json and find the entry with id: sun-screen
3. Add an object to its colors array:

  { code: IW-01, name: Ivory White, image: /images/fabrics/sun-screen/ivory-white.jpg }
