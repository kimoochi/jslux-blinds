...
2. Open /src/data/fabrics.json and find the entry with id: roll-black-out
3. Add an object to its colors array:

  { code: IW-01, name: Ivory White, image: /images/fabrics/roll-black-out/ivory-white.jpg }
